          ...
          {treeData && treeData.rootActions.length > 0 ? (
            <div style={{
              ...
              <div style={{
                ...
                <strong>Total:</strong> {treeData.rootActions.length} project{treeData.rootActions.length !== 1 ? 's' : ''} (excluding completed items)
              </div>
            ...
            <div style={{ 
              ...
              <div style={{ display: 'flex', gap: '0.5rem' }}>
                <a 
                  href={`/api/actions/tree?includeCompleted=true`}
                  target="_blank"
